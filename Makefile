...
# Build this FLEX source tree as a libFLEX dylib package.
FLEX_ROOT = .
...
$(TWEAK_NAME)_FRAMEWORKS = Foundation UIKit CoreGraphics ImageIO QuartzCore WebKit Security SceneKit
$(TWEAK_NAME)_LIBRARIES = sqlite3 z c++
$(TWEAK_NAME)_CFLAGS += -fobjc-arc -w -Wno-unsupported-availability-guard -Wno-deprecated-declarations $(IMPORTS) -g
